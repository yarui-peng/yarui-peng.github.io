...
- Let card-contained action groups inherit the nearest card heading color through shared CSS tokens; nested cards override the token only when they declare their own primary or secondary border.
