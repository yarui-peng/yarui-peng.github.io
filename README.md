...
- Keep `/research/` as the overview and project index, and give each research area its own linked page at `/research/eda4chiplet/`, `/research/eda4power/`, and `/research/eda4hi/`. Link the overview, navigation menu, and sibling area pages together with grouped buttons.
