...
- Research media should use compact, image-only galleries for design figures. Keep descriptions in image `alt` text and accessible link labels rather than adding visible captions below every image; use a two-up layout when the area contains multiple figures.
