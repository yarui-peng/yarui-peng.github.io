...
- Keep lab-member publication authors bold without padded highlight pills. In current-course cards, use the course title as the heading and show the term as a centered badge label beneath it.
