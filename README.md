...
- Reuse the shared `site-card` and `site-card-nested` hover treatment across level 1 and level 2 cards: slightly tint the surface, brighten the colored heading, and strengthen the shadow consistently.
